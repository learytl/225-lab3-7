pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/learytl'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/learytl/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('learytl-225')                                                         //<------your MiamiID
    }
